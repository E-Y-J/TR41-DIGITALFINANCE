...
### 6.1 Seed Development Data (Users & Transactions)
...
- Generates seed transactions linked to those users.
- Ensures enum fields (e.g., `role`, `transaction_type`) match backend constraints.
...
##### 2. Generate seed users and transactions
...
This will insert the users and transactions directly into the database.
...
-- Verify enum-safe roles and transaction types
...
_(To be filled by Ariel after testing)_
