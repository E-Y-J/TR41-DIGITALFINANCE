...
CATEGORY_KEYWORDS: Dict[str, List[str]] = {
    "Food & Dining": [
        ...
        "pizza", "sushi", "doordash", "grubhub", "ubereats", "chipotle",
        "subway", "wendy", "taco", "diner", "bakery", "deli", "lunch",
        "dinner", "breakfast", "food", "eat", "meal", "snack", "grocery",
        "supermarket", "walmart", "target", "costco", "kroger", "safeway",
        "trader joe", "whole foods", "aldi", "publix",
    ],
    "Transportation": [
        "uber", "lyft", "taxi", "gas", "fuel", "shell", "chevron", "exxon",
        "bp", "parking", "toll", "metro", "bus", "train", "transit",
        "airline", "flight", "car", "auto", "vehicle", "rental",
        "hertz", "enterprise", "avis", "amtrak", "greyhound",
    ],
    "Shopping & Retail": [
        "amazon", "ebay", "etsy", "shop", "store", "mall", "retail",
        "clothing", "shoes", "fashion", "bestbuy", "electronics", "apple",
        "nike", "adidas", "nordstrom", "macys", "kohls", "jcpenney",
        "home depot", "lowes", "ikea", "wayfair", "purchase", "buy",
    ],
    "Entertainment & Recreation": [
        "movie", "cinema", "theater", "concert", "game", "gaming", "steam",
        "playstation", "xbox", "nintendo", "netflix", "hulu", "spotify",
        "music", "book", "kindle", "audible", "ticket", "event", "show",
        "amc", "regal", "fun", "hobby", "gym", "fitness", "sports",
    ],
    "Healthcare & Medical": [
        "doctor", "hospital", "clinic", "pharmacy", "cvs", "walgreens",
        "medicine", "prescription", "dental", "dentist", "vision", "optometry",
        "therapy", "health", "medical", "urgent care", "lab",
    ],
    "Utilities & Services": [
        "electric", "gas bill", "water", "internet", "cable", "phone",
        "mobile", "verizon", "att", "t-mobile", "sprint", "comcast",
        "xfinity", "utility", "bill", "rent", "mortgage",
        "subscription", "netflix", "spotify", "hulu", "disney",
    ],
    "Financial Services": [
        "bank", "credit card", "insurance", "investment", "tax",
        "interest", "fee", "atm", "transfer", "zelle", "venmo", "paypal",
        "cashapp", "wire", "checking", "savings", "loan",
    ],
    "Income": [
        "payroll", "salary", "wage", "direct deposit", "paycheck", "bonus",
        "commission", "dividend", "refund", "reimbursement",
        "income", "deposit", "payment received", "freelance",
    ],
    "Government & Legal": [
        "tax", "irs", "dmv", "license", "permit", "court", "legal",
        "attorney", "lawyer", "government", "state", "federal",
    ],
    "Charity & Donations": [
        "charity", "donation", "donate", "nonprofit", "church", "temple",
        "mosque", "synagogue", "religious", "red cross", "unicef",
    ],
}
...
INTENT_KEYWORDS: Dict[str, List[str]] = {
    IntentType.CREATE_TRANSACTION: [
        "add", "spent", "bought", "paid", "purchased", "log", "record",
        "expense", "income", "received",
    ],
    IntentType.DELETE_TRANSACTION: [
        "delete", "remove", "cancel", "undo", "erase",
    ],
    IntentType.EDIT_TRANSACTION: [
        "edit", "change", "update", "modify", "fix", "correct", "adjust",
    ],
    IntentType.QUERY_SPENDING: [
        "how much", "total", "sum", "spending", "spent",
    ],
    IntentType.CONFIRM_ACTION: [
        "yes", "confirm", "ok", "sure", "proceed", "do it", "yep", "yeah",
    ],
    IntentType.CANCEL_ACTION: [
        "no", "cancel", "stop", "abort", "nevermind", "don't",
    ],
    IntentType.HELP: [
        "help", "?", "commands", "guide", "how to",
    ],
}
